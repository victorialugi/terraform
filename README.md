...
Нет шанса посмотреть план и подтвердить изменения вручную
Можно случайно удалить, перезаписать или сломать важные ресурсы
Ошибка в коде → мгновенное разрушение инфраструктуры без возможности остановиться

Зачем нужен ключ -auto-approve:

В автоматизированных CI/CD-пайплайнах (GitHub Actions, GitLab CI, Jenkins и др.), где план уже проверен на предыдущем шаге
Для быстрого тестирования и экспериментов в локальной/тестовой среде
В скриптах автоматизации, когда некому вводить "yes"
Когда изменения 100% предсказуемы и проверены заранее`
